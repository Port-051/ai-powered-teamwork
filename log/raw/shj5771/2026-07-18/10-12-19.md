...
Now updating the `pass-log-plan.md` doc's screen table to reflect the new ranking screen, then republishing both.



All 7 screens are in place with the CSS spliced correctly. Publishing the updated mockup now.
